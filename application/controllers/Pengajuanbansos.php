...
class Pengajuanbansos extends CI_Controller {
	...
	{
    $data['dok'] = $this->db->query("SELECT * FROM pengajuan WHERE Jenis_Pengajuan='Bansos'")->result();
    $data['page'] = 'operator/p_bansos/index';
		$this->load->view('operator/index',$data);
	}
	public function edit($id_subm)
	{
		$data['dok'] = $this->db->query("SELECT * FROM pengajuan WHERE id_subm=".$id_subm)->result();
		$data['page'] = 'operator/p_bansos/form-edit';
		$this->load->view('operator/index',$data);
	...
	public function download($id_subm)
	{
		...
		$this->load->view('operator/p_bansos/download',$data);
	}
