<section class="content-header">
  <h1>
    Form Informasi Umum
    <small>Konten Hibah</small>
  </h1>
  <ol class="breadcrumb">
    <li><a href="#"><i class="fa fa-dashboard"></i> Home</a></li>
    <li><a href="#">Operator</a></li>
    <li><a href="#">Konten Hibah</a></li>
      ...
      <div class="row">
        ...
        <div class="box">
         <div class="box-header">
           <h3 class="box-title">Informasi Umum
         ...
         <div class="box-body pad">
           <form action="<?php echo base_url().'index.php/adhibah/update_umum'?>" method="post">
             <?php
